<%@ page language="java" contentType="text/html; charset=US-ASCII" pageEncoding="US-ASCII" import="utils.*" %>
...
<%
String colorParamName = "color";
String color = ColorUtils.randomColor();
